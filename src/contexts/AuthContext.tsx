...
export function AuthProvider({ children }: { children: ReactNode }) {
  ...
  return (
    <AuthContext.Provider value={{ user, session, profile, loading, kioskMode, offlineMode, manualOffline, setManualOffline, signIn, enterKiosk, signOut }}>
      {children}
