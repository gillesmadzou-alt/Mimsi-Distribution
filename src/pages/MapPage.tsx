...
import {
  MapPin, Package, CheckCircle2, Clock, Undo2, AlertTriangle,
...
export default function MapPage({ onNavigate }: { onNavigate?: (page: string) => void }) {
  ...
  useEffect(() => {
    ...
    loadData();
  }, [filterDriver, filterDateFrom, filterDateTo, useDateFilter, profile, authLoading]);
  ...
  useRealtimeSubscription('map-page-drivers', ['drivers'], () => { loadData(); });
