...
const MANUAL_DATE = '18 août 2026';
...
const MANUAL_GROUPS: ManualGroup[] = [
  {
    ...
    sections: [
      {
        id: 'routine-journee',
        title: 'Démarrer une journée de travail',
        content: [
          '1. Connectez-vous pendant que le téléphone a accès à Internet afin de récupérer les dernières données.',
          '2. Ouvrez le Tableau de bord pour vérifier les alertes, les tournées actives, les créances et le stock.',
          '3. Si vous devez travailler sans réseau, ouvrez le menu latéral et cliquez sur « Activer le mode hors-ligne ».',
          '4. Attendez la fin complète du téléchargement, puis vérifiez que l’indicateur de synchronisation confirme le mode hors ligne.',
          '5. À la fin de la journée, réactivez la connexion : les opérations marquées en attente se synchronisent automatiquement.',
        ],
      },
      {
        id: 'procedure-tournee',
        title: 'Créer une tournée et déposer des pots',
        content: [
          '1. Ouvrez « Tournées », puis cliquez sur « Nouvelle tournée ».',
          '2. Choisissez le commercial, le type de tournée, les points de vente et les quantités ou types de pots à emporter.',
          '3. Enregistrez la tournée : elle apparaît alors dans la liste avec le nombre de pots à déposer.',
          '4. Sur la carte de la tournée, cliquez sur « Déposer des pots », sélectionnez le point de vente et le type de pot.',
          '5. Saisissez la quantité, choisissez comptant ou crédit, puis validez le dépôt. Scannez les codes-barres si cette fonction est utilisée.',
          '6. Le compteur « restants » est recalculé depuis les dépôts enregistrés. Une fois la tournée terminée, cliquez sur « Clôturer ».',
        ],
      },
      {
        id: 'procedure-retour',
        title: 'Enregistrer un retour ou un invendu',
        content: [
          '1. Ouvrez « Retours et invendus » puis cliquez sur « Nouveau retour ».',
          '2. Sélectionnez la tournée et le point de vente concernés.',
          '3. Choisissez le motif, puis indiquez les pots, couvercles, pots vides ou madeleines ramenés.',
          '4. Vérifiez les quantités avant de valider : elles alimentent les écarts, les statistiques et la clôture de tournée.',
          '5. Hors ligne, validez normalement : le retour sera indiqué comme en attente, puis synchronisé dès le retour du réseau.',
        ],
      },
      {
        id: 'procedure-creance',
        title: 'Consulter une créance et enregistrer un encaissement',
        content: [
          '1. Ouvrez « Créances » et utilisez les filtres pour retrouver un commercial ou un point de vente.',
          '2. Ouvrez la ligne de créance voulue pour consulter le montant total, le montant déjà payé et le reste à payer.',
          '3. Cliquez sur « Enregistrer un paiement », saisissez le montant réellement reçu et ajoutez une note si nécessaire.',
          '4. Validez : le statut passe automatiquement à partiel ou soldé selon le montant saisi.',
          '5. Vérifiez le Tableau de bord après synchronisation pour voir le montant encaissé dans les indicateurs globaux.',
        ],
      },
      {
        id: 'procedure-stock',
        ...
        content: [
          '1. Ouvrez « Stock » et contrôlez les alertes ou le niveau disponible du type de pot concerné.',
          '2. Cliquez sur « Mouvement ». Choisissez une entrée, une sortie, un retour ou un ajustement.',
          '3. Sélectionnez le type de pot, indiquez la quantité et, si demandé, le commercial ou le fournier responsable.',
          '4. Ajoutez une note expliquant l’opération puis validez.',
          '5. Consultez l’historique sous le type de pot pour vérifier que le mouvement a bien été enregistré.',
        ],
      },
      {
        id: 'procedure-offline',
        title: 'Travailler correctement hors ligne',
        content: [
          '1. Activez le mode hors ligne avant de perdre le réseau et attendez la confirmation de téléchargement.',
          '2. Continuez vos saisies habituelles : dépôts, retours, production et mouvements sont conservés sur cet appareil.',
          '3. Repérez l’indicateur de synchronisation : il montre les opérations qui restent à envoyer.',
          '4. Ne vous déconnectez pas du compte avant la synchronisation, car la déconnexion efface les données locales de sécurité.',
          '5. Dès que le réseau revient, désactivez le mode hors ligne ou attendez la synchronisation automatique, puis contrôlez que le compteur d’attente revient à zéro.',
        ],
      },
    ],
  },
    ...
    sections: [
      ...
      },
      {
        ...
        content: [
          ...
          'Un seul indicateur de synchronisation apparait en haut a droite. Il affiche le mode hors ligne, les operations en attente et l\'etat de synchronisation.',
          'Toutes les donnees accessibles a votre compte sont telechargees localement avant l\'activation du mode hors ligne. Vos nouvelles saisies sont synchronisees automatiquement des que la connexion revient.',
        ],
      },
      {
        id: 'mise-a-jour',
