...
export const NAV_SECTIONS: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'production', label: 'Pétrisseurs & Production', description: 'Production quotidienne de madeleines par fournier', icon: ChefHat, minRole: 2 },
  ...
  },
  {
    ...
    items: [
      { id: 'users', label: 'Personnel', description: 'Ajout et gestion centralisée de tout le personnel', icon: UserCog, minRole: 6, allowedRoles: [6] },
