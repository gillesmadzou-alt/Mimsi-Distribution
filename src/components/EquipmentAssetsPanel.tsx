...
export default function EquipmentAssetsPanel({ canRecord }: { canRecord: boolean }) {
  ...
  return <section className="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm sm:p-5">
    ...
    <p className="mt-3 rounded-xl bg-slate-50 p-3 text-sm text-slate-700">Le rapport des matériels et outils est disponible dans la section <strong>Rapports</strong>, au format PDF ou Excel.</p>
